...
public class AppiumBaseClass {
	...
	public static void inlink() throws MalformedURLException, InterruptedException  {
		...
		cap.setCapability("app", "C:/Users/admin/Downloads/Inlink_test_26_06_23.apk");
	...
	public static void login() throws InterruptedException {
		...
		/*driver.findElement(By.id("com.peoplelink.inlink:id/emailET")).sendKeys("hexagon@yopmail.com");
