...
public class LongPressBroadcast extends AppiumBaseClass {
	

	
	@Test
	public void longPressBroadcast() throws InterruptedException {
    ...
    broadCast.click();
    //driver.findElement(By.xpath("//contains[text(),“2”]"));
