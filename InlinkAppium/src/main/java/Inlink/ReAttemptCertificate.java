...
public class ReAttemptCertificate extends AppiumBaseClass {
	
	@Test
	public void reattempt() throws InterruptedException {
		...
		searchTxt.sendKeys("t10");
		
		WebElement getCertificate = wait.until(ExpectedConditions.elementToBeClickable(By.id("com.peoplelink.inlink:id/getCertificateBtn")));
